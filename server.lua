...
RegisterServerEvent('rep-rental:server:giveRentalPaper', function(plate, model)
   ...
   -- info.price = RentPrice
    info.vehiclename = model

    Player.Functions.AddItem('renting_contract', 1, nil, info)
    TriggerClientEvent('inventory:client:ItemBox', source, Core.Shared.Items["renting_contract"], "add")
...
--Core.Functions.CreateUseableItem("renting_contract", function(source, item)
